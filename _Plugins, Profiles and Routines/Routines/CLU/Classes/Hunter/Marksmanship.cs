...
namespace CLU.Classes.Hunter
{
    ...
    class Marksmanship : RotationBase
    {
        ...
        {
            get { return "Marksmanship Hunter"; }
        }
                    ...
                    // Trinkets & Cooldowns
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                                ...
                                Spells.CastSpell("Multi-Shot",              ret => Units.CountEnnemiesInRange(Me.CurrentTarget.Location, 20) > 4, "Multi-Shot"),
                                Spells.CastSpell("Steady Shot",             ret => Units.CountEnnemiesInRange(Me.CurrentTarget.Location, 20) > 4, "Steady Shot"),
                                ...
                                // Main rotation
                                Buff.CastDebuff("Serpent Sting",            ret => Buff.TargetDebuffTimeLeft("Serpent Sting").TotalSeconds <= 0.5 && (Me.CurrentTarget.HealthPercent <= 90 || Me.CurrentTarget.MaxHealth == 1), "Serpent Sting"),
                                Spells.CastSpell("Chimera Shot",            ret => Me.CurrentTarget.HealthPercent <= 90 || Me.CurrentTarget.MaxHealth == 1, "Chimera Shot"),
                                ...
                                Spells.CastSpell("Steady Shot",             ret => Buff.PlayerActiveBuffTimeLeft("Improved Steady Shot").TotalSeconds < 3, "Steady Shot (Improved Steady Shot) [" + Buff.PlayerActiveBuffTimeLeft("Improved Steady Shot").TotalSeconds + "]"),
                                Items.RunMacroText("/cast Aimed Shot!",     ret => Buff.PlayerHasActiveBuff("Fire!"), "Aimed Shot (Fire!)"),
                                Spells.CastSpell("Arcane Shot",             ret => (Me.FocusPercent >= 66 || Spells.SpellCooldown("Chimera Shot").TotalSeconds >= 4) && (Me.CurrentTarget.HealthPercent < 90 && !Buffs.UnitHasHasteBuff(Me)), "Arcane Shot"),
                                Spells.CastSpell("Aimed Shot",              ret => (Me.FocusPercent >= 80 || Spells.SpellCooldown("Chimera Shot").TotalSeconds > 5) && (Buffs.UnitHasHasteBuff(Me) || (Me.CurrentTarget.HealthPercent > 90)), "Aimed Shot (RF, Lust or Hero or TW"),
                                Spells.CastSpell("Steady Shot",             ret => true, "Steady Shot"))))));
            }
        }

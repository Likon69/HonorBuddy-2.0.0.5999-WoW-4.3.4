        ...
        public override string Help
        {
            get
            {
                return "\n" +
                       ...
                       "2. Totems: Stoneskin Totem, Wrath of Air, Healing Stream Totem, Searing (with range check) \n" +
            ...
            get
            {
                return new Decorator(ret => !SettingsFile.Instance.AutoManagePauseRotation,
                    ...
                    new PrioritySelector(
                        ...
                        new Decorator(
                                ret => !Me.IsMoving && Units.CountEnnemiesInRange(Me.CurrentTarget.Location, 8) >= 2 && !BossList.IgnoreAoE.Contains(Me.CurrentTarget.Entry),
                                    new PrioritySelector(
                                        ...
                                        Spells.CastSpell("Earthquake",              ret => true, "Earthquake"),
						...
						Spells.CastSpell("Earth Shock", 			ret => Buff.PlayerCountBuff("Lightning Shield") > 7, "Earth Shock"),
                        ...
                        Spells.CastSpell("Unleash Elements",        ret => Me.IsMoving, "Unleash Elements - Moving"),
                        Spells.CastSpell("Thunderstorm",            ret => true, "Thunderstorm")
                        )));
            }
        }
            ...
            get
            {
                return new Decorator(
                    ...
                    new PrioritySelector(
                        ...
                        Buff.CastBuff("Flametongue Weapon", 		ret => !Item.HasWeaponImbue(WoWInventorySlot.MainHand, "Flametongue") && Item.HasSuitableWeapon(WoWInventorySlot.MainHand), "Flametongue Weapon")
                        ));
            }
        }

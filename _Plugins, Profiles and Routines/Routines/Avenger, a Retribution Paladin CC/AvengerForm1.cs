...
namespace Avenger
{
    public partial class AvengerConfig : Form
    {
        ...
        private void AvengerForm1_Load(object sender, EventArgs e)
        {
            ...
            DSL.Checked = AvengerSettings.Instance.DSL;
        ...
        private void DSL_CheckedChanged(object sender, EventArgs e)
        {
            if (DSL.Checked == true)
            {
                AvengerSettings.Instance.DSL = true;
            }
            else
            {
                AvengerSettings.Instance.DSL = false;
            }
        }

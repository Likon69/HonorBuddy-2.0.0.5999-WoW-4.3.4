...
namespace Hera
{
    public partial class Codemplosion
    {
        ...
        public class NeedToCancelDrink : Decorator
        {
            ...
            protected override bool CanRun(object context)
            {
                if (Me.IsInInstance && Settings.PartyHealWhen.Contains("dedicated") && Self.IsPowerPercentAbove(50) && (RAF.PartyTankRole != null && RAF.PartyTankRole.HealthPercent < 65)) return true;
        ...
        public class AutoAttack : Action
        {
            protected override RunStatus Run(object context)
            {
                Utils.AutoAttack(!Settings.PartyHealWhen.Contains("dedicated"));

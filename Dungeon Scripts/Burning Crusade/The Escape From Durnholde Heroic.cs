...
{
    public class TheEscapeFromDurnholdeHeroic : Dungeon
    {
        ...
        public override void IncludeTargetsFilter(List<WoWObject> incomingunits, HashSet<WoWObject> outgoingunits)
        {
            ...
            {
                var unit = u as WoWUnit;
                if (unit != null && thrall != null && unit.CurrentTarget == thrall)
        ...
        {
            var thrall = ObjectManager.GetObjectsOfType<WoWUnit>().FirstOrDefault(u => u.Entry == 17876);
            foreach (var priority in units)
            {
                ...
                if (unit != null)
                {
                    ...
                    if (thrall != null && unit.CurrentTarget == thrall)
                        priority.Score += 200;
                }
            }
        }
        ...
        public Composite ErozionEncounter()
        {
            return new PrioritySelector(
                ...
                new Decorator(
                    ...
                    new TreeSharp.Action(ctx => Mount.Dismount())),
            ...
            return new PrioritySelector(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        ...
                        new Decorator(
                            ctx => barrel != null,
                            new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(barrel.Location))),
                        new Decorator(
                            ctx => barrel != null && barrel.DistanceSqr < 7 * 7 && Targeting.Instance.FirstUnit == null,
                            ScriptHelpers.CreateInteractWithObject(182589, 6)),

                        new Decorator(ctx => barrel == null,
                            new PrioritySelector(
                                new Decorator(
                                    ctx => StyxWoW.Me.Location.Distance2DSqr((WoWPoint)ctx) <= 3 * 3,
                                    new TreeSharp.Action(ctx => _barrelLocations.Dequeue())),
                                new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo((WoWPoint)ctx)))))));
        }
        ...
        public Composite EpochHunterEncounter()
        {
            ...
            return new PrioritySelector(
                ...
                new Decorator(ctx => _epochHunter != null && _epochHunter.Combat,
                    ScriptHelpers.CreateTankFaceAwayGroupUnit(20)),
                new Decorator(
                    ctx => !_epochHunterStep1Done,
                    new PrioritySelector(
                        new Decorator(ctx => StyxWoW.Me.Location.DistanceSqr(thrallStartLoc1) < 5 * 5 && _thrall == null,
                            new TreeSharp.Action(ctx => _epochHunterStep1Done = true)),
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        new Decorator(ctx => StyxWoW.Me.Location.DistanceSqr(thrallStartLoc3) < 5 * 5 && _thrall == null,
                            new TreeSharp.Action(ctx => _epochHunterStep2Done = false)),

                        new Decorator(ctx => _taretha != null && _taretha.CanGossip,
                            new Sequence(

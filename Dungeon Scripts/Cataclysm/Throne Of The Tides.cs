...
#endif
{
    public class ThroneOfTheTides : Dungeon
    {
        ...
        public override uint DungeonId { get { return 302; } }
        ...
        public override void WeighTargetsFilter(List<Targeting.TargetPriority> units)
        {
            foreach (var t in units)
            {
                ...
                if ((prioObject.Entry == Sapper || prioObject.Entry == MindLasher ||
                     prioObject.Entry == NazjarSpiritmender) && StyxWoW.Me.IsDps()) // 
                    t.Score += 500;
            ...
            return new PrioritySelector(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        ...
                        // Fungal Spores
                        ScriptHelpers.CreateRunAwayFromBad(ctx => true, 10, 40597),
                        // Geyser
                        ScriptHelpers.CreateRunAwayFromBad(
                            ctx => _ladyNazjar != null && _ladyNazjar.HasAura("Waterspout"), 12, 40586),
                        // Waterspout

...
#endif
{
    public class LostCityOfTheTolvir : Dungeon
    {
        ...
        public override uint DungeonId { get { return 312; } }
        ...
        public Composite GeneralHusamEncounter()
        {
            ...
            return new PrioritySelector(
                ...
                ScriptHelpers.CreateRunAwayFromBad(
                    ctx => true, 8, u => u.Entry == landMine && u.DistanceSqr <= 14 * 14 && u.ToUnit().HasAura("Tol'vir Land Mine Visual")),
                ScriptHelpers.CreateRunAwayFromBad(
                    ctx => true, 3, u => u.Entry == landMine && u.DistanceSqr <= 10 * 10 && !u.ToUnit().HasAura("Tol'vir Land Mine Visual")),
                ScriptHelpers.CreateRunAwayFromBad(ctx => true, 5, u => u.Entry == shockwaveVisual && u.DistanceSqr <= 10 * 10)
                );
        }
        ...
        public Composite HighProphetBarimEncounter()
        {
            ...
            return new PrioritySelector(
                ...
                ScriptHelpers.CreateRunAwayFromBad(
                    ...
                    HarbingerOfDarkness),
                ScriptHelpers.CreateRunAwayFromBad(
                    ctx => true, () => roomCenterLoc, 30, 15, u => u.Entry == HighProphetBarim && u.ToUnit().HasAura(Repentance)),
        ...
        public Composite SiamatEncounter()
        {
            ...
            return new PrioritySelector(
                ...
                ScriptHelpers.CreateRunAwayFromBad(ctx => true, 12, u => u.Entry == ServantOfSiamat && u.ToUnit().HealthPercent <= 5)
                );
        }

        readonly WaitTimer _windTunnelTimer = new WaitTimer(TimeSpan.FromSeconds(15));

...
namespace Styx.Bot.Quest_Behaviors.InteractWith2
{
    ...
    /// </summary>
    public class InteractWith2 : CustomForcedBehavior
    {
        ...
        public InteractWith2(Dictionary<string, string> args)
            : base(args)
        {
            try
            {
        ...
        public override string SubversionId { get { return ("$Id: InteractWith.cs 255 2012-12-06 05:10:21Z natfoth $"); } }
        public override string SubversionRevision { get { return ("$Revision: 255 $"); } }
